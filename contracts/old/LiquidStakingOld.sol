 ...
 */
contract LiquidStakingOld is Initializable, AccessControlUpgradeable {
    ...
    function initialize(
        ...
        DNTname = _DNTname;
        utilName = _utilName;
        distr = NDistributorOld(_distrAddr);
        dntToken = _dntToken;
