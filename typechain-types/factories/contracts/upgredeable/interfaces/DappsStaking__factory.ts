...
import type {
  DappsStaking,
  DappsStakingInterface,
} from "../../../../contracts/upgredeable/interfaces/DappsStaking";
...
export class DappsStaking__factory {
  static readonly abi = _abi;
  static createInterface(): DappsStakingInterface {
    return new utils.Interface(_abi) as DappsStakingInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): DappsStaking {
    return new Contract(address, _abi, signerOrProvider) as DappsStaking;
  }
}
