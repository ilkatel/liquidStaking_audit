...
export interface NDistributorOldInterface extends utils.Interface {
  functions: {
...
export interface NDistributorOld extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NDistributorOldInterface;
